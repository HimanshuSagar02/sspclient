...
const navItems = [
  ...
  { to: '/admin/site', label: 'Website CMS', icon: Globe },
  { to: '/admin/users', label: 'Users', icon: Users },
  { to: '/admin/coaching', label: 'Coaching', icon: BookOpen },
  ...
  { to: '/admin/library-seats', label: 'Library Seats', icon: Library },
    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      >
        <div className="flex h-16 items-center gap-2 border-b border-white/10 px-6">
          ...
          <div>
            <p className="font-semibold text-sm">Srishti ERP</p>
      ...
      <div className="flex flex-1 flex-col min-w-0">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 lg:px-8">
          ...
          <Link to="/" className="text-sm text-brand-600 hover:underline hidden sm:block">
            View public site →
          </Link>
        ...
        <main className="flex-1 p-4 lg:p-8">
          <ErrorBoundary scope="This admin page" homePath="/admin">
            <Outlet />
          </ErrorBoundary>
        </main>
      </div>
